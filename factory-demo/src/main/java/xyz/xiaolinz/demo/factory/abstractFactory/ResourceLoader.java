package xyz.xiaolinz.demo.factory.abstractFactory;

import java.util.HashMap;
import java.util.Map;
import java.util.Map.Entry;
import java.util.Properties;
import xyz.xiaolinz.demo.factory.abstractFactory.factory.ResourceLoaderFactory;
import xyz.xiaolinz.demo.factory.abstractFactory.product.Resource;
...
public class ResourceLoader {
  ...
  public Resource load(String url) {
    ...
    // 2.根据前缀获取资源
    return resourceLoaderFactory.loaderPicture(url);
  }
